...
function App() {
  return (
    ...
    <div className='grid'>
        ...
        <div className='bg-white two'>
          {/* image a little small on tablet, space between a little large */}
          <img className="overflow-hidden"src={socials} alt="example X and Twitter links" />
          <h3 className='text-preset-3'>Manage multiple accounts and platforms.</h3>
        </div>
        <div className='bg-yellow-dark no-bottom-padding three'>
        ...
        <div className='bg-purple-light text-center tablet-2-col align-items-center four'>
        ...
        <div className='bg-purple-dark tablet-2-col space-around align-items-center five'>
        ...
        <div className='bg-white tablet-2-col space-between six'>
        ...
        <div className='bg-yellow-light seven'>
        ...
        <div className='bg-yellow-dark eight'>
